...
function HomeTemplate() {
  ...
  return (
    <Box minHeight={"100vh"} >
      ...
      <Box display="flex" position="relative" left="80px" width="91%" padding="10px">
      <Banner/>
      </Box>
      <Box position="relative" padding={"50px"} left="80px" width={"80%"}>
      ...
      <CardsList librarybu={true} checkComplete={31}></CardsList>
      <Box className={classes.libraryText}>Featured audio blinks</Box>
      <CardsList librarybu={true} checkComplete={100}></CardsList>
      </Box> 
