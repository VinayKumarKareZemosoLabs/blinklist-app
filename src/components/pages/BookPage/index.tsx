...
import Buttons from "../../molecules/Button";
...
function BookTemplate(props:Props) {
  ...
  return (
    ...
    <Box width="90%" padding="0% 5%">
      ...
      <Box display={"flex"} width="99%" padding={"60px 0px"}>
        <Box  width="100%">
          <Box display={"flex"} justifyContent="flex-start" flexWrap={"wrap"}>
            <Box width="100%" color={'#03314B'} fontSize={"16px"} lineHeight={"20px"} textAlign="left" marginLeft="8%">
            Get the key ideas from
            </Box>
            <Box width="38%" paddingTop={"1%"} textAlign="left" marginLeft={"8%"}>
            ...
            {/* {book?.complete === 31 ?    <Buttons name={"Finished Reading"} onClick={()=>{}} classing={"connect"} disabled={true} icon={undefined} end={undefined}></Buttons>} */}
          ...
          <Box width="80%" padding={"60px 0px"} marginLeft="8%" marginTop={"-2%"} fontFamily={"Cera Pro"}>
            ...
            TabIndicatorProps={{
              style: {
                ...
                <Tab value="1" label="Synopsis" sx={{textTransform:"none", width:"33%",alignItems:"flex-start",borderBottom:1,borderColor : "#E1ECFC"} } font-family="Cera Pro" />
                <Tab value="2" label="Who is it for?" sx={{textTransform:"none", width:"33%",alignItems:"flex-start",borderBottom:1,borderColor : "#E1ECFC"}} font-family="Cera Pro"></Tab>
                <Tab value="3" label="About the author" sx={{textTransform:"none", width:"33%",alignItems:"flex-start",borderBottom:1,borderColor : "#E1ECFC"}} font-family="Cera Pro"></Tab>
              </TabList>
              <Box width="50%" minHeight={"200px"} marginLeft="0.5%" fontFamily={"Cera Pro"} justifyContent={"left"} textAlign={"left"}>
